...
from dataloader import LunaTestDataset, LunaTestFalsePositiveDataset, getDataInfoDict, getTestDataList, getTestCt 
from unet2dmodel import UNetWrapper
...
class NoduleAnalysisApp:
    def __init__(self, sys_argv=None):
        ...
        parser.add_argument('--segmentation-path',
            ...
            default='2D-Unet-segmentation.state',
        )
